...
# 网络结构
class BiGAT_door(torch.nn.Module):
    def __init__(self,in_feats,hid_feats,out_feats,num_class,dropout):
        super(BiGAT_door, self).__init__()
        self.TDGCN = TDGAT(in_feats, hid_feats, out_feats)
        self.BUGCN = BUGAT(in_feats, hid_feats, out_feats)
